...
In diesen Tests läuft C schneller als C++, jedoch verfügt C++ über viele zu\-sätz\-liche Funktionen, die die Programmierung erleichtern können. Zusätzliche Funktionen besitzt auch die Sprache Rust, welche durchschnittlich wie C performt.
